...
const ShinyButton = ({
  ...
  return (
      <motion.button
          {...animationProps}
          className={cn(
              "relative rounded-lg px-6 py-2 font-medium backdrop-blur-xl transition-[box-shadow] duration-300 ease-in-out hover:shadow dark:bg-[radial-gradient(circle_at_50%_0%,hsl(0_0%_98%/10%)_0%,transparent_60%)] dark:hover:shadow-[0_0_20px_hsl(0_0%_98%/10%)]",
              className,
          )}
          onClick={onClick}
      >
