...
export const GrowthChart = ({ label, value }: GrowthChartProps) => {
    ...
    return (
        <div
            ref={ref}
            className="dark:shadow-none shadow-xl overflow-hidden rounded-lg border dark:border-neutral-800 border-neutral-300 w-[300px]"
        >
