...
export const CommunicationModel = ({ className }: { className?: string }) => {
    ...
    return (
        <div
            className={cn(
                "relative flex h-[500px] w-full items-center justify-center overflow-hidden rounded-lg border bg-white dark:bg-black p-10 md:shadow-xl",
                className,
            )}
            ref={containerRef}
        >
