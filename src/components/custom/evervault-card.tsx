    ...
    >
      ...
      >
        ...
        <div className="relative z-10 flex items-center justify-center">
          <div className="relative size-36 rounded-full flex items-center justify-center text-white font-semibold text-3xl">
            <div className="absolute w-full h-full bg-black/[0.85] blur-xs rounded-full" />
            <span className="text-white font-poppins z-20">{text}</span>
          </div>
        </div>
      </div>
    </div>
