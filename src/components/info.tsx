  ...
  return (
    <div className="flex flex-col gap-y-3.5 items-center justify-center px-4 md:px-10 my-16 max-w-7xl mx-auto">
      <div className="flex flex-col items-center text-start md:text-center gap-y-2 px-4 md:my-8">
        <h3 className="text-3xl sm:text-4xl 2xl:text-5xl font-bold font-poppins">SMS verification that <span className="font-black">JUST</span> works.</h3>
      ...
      <div className="grid grid-cols-1 grid-rows-2 md:grid-cols-2 md:grid-rows-1 gap-4">
        ...
        <div className="flex flex-col md:justify-evenly gap-y-8 md:gap-y-4 md:-mt-3">
          <div className="flex flex-row gap-x-2.5">
            <TbLabelImportantFilled className="flex-shrink-0 mt-2 size-7 xl:size-9 text-cyan-400" />
            <div>
              <h4 className="text-lg xl:text-xl font-semibold">High Quality Numbers</h4>
              <p className="text-sm xl:text-base text-neutral-200">
          ...
          <div className="flex flex-row gap-x-2.5">
            <IoPricetag className="flex-shrink-0 mt-2 size-7 xl:size-9 text-cyan-400" />
            <div>
              <h4 className="text-lg xl:text-xl font-semibold">Fixed Pricing</h4>
              <p className="text-sm xl:text-base text-neutral-200">
